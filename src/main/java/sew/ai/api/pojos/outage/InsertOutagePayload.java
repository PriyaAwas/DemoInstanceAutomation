...
public class InsertOutagePayload {
    String Type;
    String Cause;
    String StartTime;
    String Circuit;
    ...
    public InsertOutagePayload(User user, Outage outage) {
        Type = "0";
        ...
        try {
            ResultSet rs = DataBaseUtils.getResultSet(SQLQueries.getOutageIdQuery(user.getUserName()));
            while (rs.next()) {
