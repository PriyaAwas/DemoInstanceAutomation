...
public class ConnectMePayload {
    ...
    public ConnectMePayload(User user, ConnectMe connectMe) {
//        PlaceHolderID = ConnectMe.getPlaceHolderID();
...
//        Latitude = ConnectMe.getLatitude();
//        Longitude = ConnectMe.getLongitude();
...
//        LanguageCode = ConnectMe.getLanguageCode();
//        ResponseXML = ConnectMe.getResponseXML();
//        TemplateTypeId = ConnectMe.getTemplateTypeId();
//        AttachmentXML = ConnectMe.getAttachmentXML();
//        //UserID =3301;
//        this.UserID = Integer.parseInt(user.getUserId());
//        LocationAddress = ConnectMe.getLocationAddress();
//        serviceid = ConnectMe.getServiceId();
//        SaveId = ConnectMe.getSaveId();
//        isEmailFromControl = ConnectMe.getisEmailFromControl();
//        GroupId = ConnectMe.getGroupId();
//        serviceRequestId = ConnectMe.getServiceRequestId();
//        CustomerName = ConnectMe.getCustomerName();
//        comments = ConnectMe.getComments();
    }
