...
public class CompareWaterResponse {
    ...
    private CompareWaterResponse[] compareWaterResponses;

    public CompareWaterResponse() {
    }

    public CompareWaterResponse getCompareWaterDataOnBillDate(String billDate) {
        return Arrays.stream(compareWaterResponses).filter(compareWaterResponse -> compareWaterResponse
                .getBillDate()
    ...
    public CompareWaterResponse[] getCompareWaterResponses() {
        return compareWaterResponses;
    }

    public void setCompareWaterResponses(CompareWaterResponse[] compareWaterResponses) {
        this.compareWaterResponses = compareWaterResponses;
    }
}
