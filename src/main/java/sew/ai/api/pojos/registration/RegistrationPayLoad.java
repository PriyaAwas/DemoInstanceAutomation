...
public class RegistrationPayLoad {
    ...
    public RegistrationPayLoad(Customer customer, Random random, HashMap<String, String> map) {
        AccountNumber = 0;
        FirstName = customer.getFirstName() + random.nextInt(100);
        MiddleName = null;
        LastName = customer.getLastName() + random.nextInt(100);
        EmailId = customer.getEmailAddress() + random.nextInt(100) + "@mailinator.com";
        ...
        UserName = customer.getUserName() + random.nextInt(500);
        Password = "Demo@123";
