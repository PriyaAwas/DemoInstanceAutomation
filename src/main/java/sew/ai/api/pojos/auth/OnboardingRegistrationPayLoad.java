...
public class OnboardingRegistrationPayLoad {
...
public OnboardingRegistrationPayLoad(Customer reg,Random random,HashMap<String,String> map) {
	
	AccountNumber =0;
	FirstName = reg.getFirstName()+ random.nextInt(100);
	MiddleName=null;
	LastName =reg.getLastName()+ random.nextInt(100);
	EmailId= reg.getEmailAddress()+ random.nextInt(100)+"@mailinator.com";
	DateOfBirth="0001-01-01T00:00:00";
	MobileNumber =reg.getPhoneNumber();
	HomePhone =null;
	Address1 =null;
	Address2 =null;
	IsPasswordRequest =0;
	CityId =0;
	PostalCode = map.get("zipCode");
	UserName =reg.getUserName()+"@_"+random.nextInt(500)+"5";
	Password="Demo@123";
	...
	Longitude=0.0;
	SSNNumber ="";
	UtilityAccountNumber =map.get("utilityAccountNumber");
	IsVerfication =0;
	SessionCode =null;
