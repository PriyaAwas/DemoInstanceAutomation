...
public class UsageResponse {
    ...
    private UsageResponse[] usageResponses;
    ...
    public UsageResponse[] getUsageResponses() {
        return usageResponses;
    }

    public void setUsageResponses(UsageResponse[] usageResponses) {
        this.usageResponses = usageResponses;
    }
}
