...
public class WindowList {
    ...
    private void markCurrentWindow() {
        ...
        if (!currentWindowHandle.equals(windowHandles.get(currentWindow))) {
            currentWindow = windowHandles.indexOf(currentWindowHandle);
        }
    }
    ...
    protected void goToNewWindow() {
        ...
        String timeoutMessage = StringUtil.format("A new window/page/tab did not load in the configured new window timeout of {} seconds.", Time.out().getSeconds());
