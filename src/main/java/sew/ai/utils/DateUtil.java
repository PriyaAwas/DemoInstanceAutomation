...
public class DateUtil {
    ...
    public static String getCurrentMonthLastYear(String format) {
        SimpleDateFormat formatter = new SimpleDateFormat(format);
        Calendar cal = Calendar.getInstance();
    ...
    public static String getCurrentDateTimeInAPIFormat() {
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss");
        LocalDateTime now = LocalDateTime.now();
        expDateTime = dtf.format(now);
        return expDateTime;
    }

    public static Boolean isValidDateInFormat(String inputDate, String pattern) {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(isValidDateInFormat(date, "MMM yyyy"));
    }
}
