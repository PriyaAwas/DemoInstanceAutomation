...
public class NotificationPreferencePage extends HomePage {
	...
	public boolean isLblConnectMeTextVisible() {
		log.info("Checking the visibility of lblConnectMeText on the page.");
		log.info("lblConnectMeText visibility status : " + isElementVisible(lblConnectMeText));
		return isElementVisible(lblConnectMeText);
	}

	public String getLevelConnectMeText() {
		log.info("Fetching the Notification  header.");
		String label = getText(lblConnectMeText);
		log.info("Notification page header is {}: " + label);
		return label;
	}

	public void clickLevelConnectMeText() {
		click(lblConnectMeText);
	...
	public boolean isIconConnectMeAddVisible() {
	...
	public boolean isBtnConnectMeCancel() {
	...
	public boolean isBtnConnectMeSave() {
