...
public class NotificationPage extends HomePage {
	private static final Logger log = LogManager.getLogger(NotificationPage.class);
	...
	@FindBy(css = "[id='NotificationAlertCount']")
	...
	private WebElement chkBoxInputFieldSelectNotifyDd;
	...
	private WebElement btnNotificationGridFirstNotificationDeleteButton;
