...
public class PreLogConnectMePage extends HomePage {
    private static final Logger log = LogManager.getLogger(PreLogConnectMePage.class);

    public PreLogConnectMePage(WebDriver driver) {
        super(driver);
        PageFactory.initElements(driver, this);
    }

    @FindBy(xpath = "(//a[@globalize='ML_CONNECTMEMaster_Anchor_ContactUs'])[1]")
    ...
    public boolean isInstagramTabVisible() {
    	log.info("Instagram Tab Status :" + tabInstagram.isDisplayed());
    	return tabInstagram.isDisplayed();
    }
    ...
    public String getResendOtpTrackRequestClass() {
        String timer = getAttribute(txtContactUsCustomerName, "class");
        log.info("Max length of Customer Name field is {} " + timer);
        return timer;
    }
...
//Labels
    ...
    public boolean isTrackReqSidebarReqSubjectVisible() {
    	log.info("Track Request Sidebar Req Subject is visibility Status :" + lbl_TrackReqSidebarReqSubject.isDisplayed());
    ...
    public boolean isTrackReqSidebarReqRaisedOnVisible() {
    	log.info("Track Request Sidebar Req Raised On visibility Status :" + lbl_TrackReqSidebarReqRaisedOn.isDisplayed());
    ...
    public String getPageHeaderPost() {
    ...
    public boolean isPostloginCustomerServiceContactNoVisible() {
    	log.info("Post login Customer Service Contact No Status :" + lblpostloginCustomerServiceContactNo.isDisplayed());
    ...
    private WebElement  btnTrackReq;
    
    public boolean isBtnTrackReqVisible() {
    	log.info("Track Req Status is:" + btnTrackReq.isDisplayed());
    	return btnTrackReq.isDisplayed();
    }
    
    public void clickBtnTrackReq() {
    	click(btnTrackReq);
    	log.info("Track Req  Tab clicked {}.");
    }
   ...
   //TextBox
    ...
    public String getTextCustomerName() {
        ...
        String label = getText(txtCustomerName);
        log.info("Customer Name label is {}: " + label);
        return label;
    }
    ...
    public void populatetxtTrackReqSearch(String trackReqId) {
        log.info("Track Req Search {} :" + trackReqId);
        sendKeys(txtTrackReqSearch, trackReqId);
        log.info("Track Req Search populated successfully.");
    }
    ...
    public String getTrackRequestDate() {
        log.info(" get txt Track Request Date");
        String label = getText(txtTrackRequestDate);
        log.info("txt Track Request Date: " + label);
        return label;
    }
    ...
    public String getCaseNumber() {
        log.info("Fetching the Case Number");
        String label = getText(lblCaseNumber);
        log.info("Case Number: " + label);
        return label;
    }
...
//    private WebElement th_SavedFormsHeaders;
...
//    private WebElement th_PostLoginTrackReqGridHeader;
...
//    private WebElement td_PostLogTrackReqRaisedOnCol;
    ...
    @FindBy(css = "[class='waysttosave_ico commonmtr_dgn']")
