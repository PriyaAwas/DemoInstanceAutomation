...
public class PostLogConnectMePage extends HomePage {
    private static final Logger log = LogManager.getLogger(PostLogConnectMePage.class);

    public PostLogConnectMePage(WebDriver driver) {
        super(driver);
...
//Labels
   ...
   //TextBox
    ...
    @FindBy(xpath = "//label[(text()='Service Account Number') or (text()='Account Numbner')]/..//input")
