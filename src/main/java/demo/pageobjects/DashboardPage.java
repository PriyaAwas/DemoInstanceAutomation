...
public class DashboardPage extends HomePage {
	...
	public String getSoFarThisMonthLabel() {
    	scrollToElement(lbl_so_far_this_month);
	...
	public String getHowYouAreDoingSoFar() {
		scrollToElement(lbl_how_you_are_doing_so_far);		String label = getText(lbl_how_you_are_doing_so_far);
