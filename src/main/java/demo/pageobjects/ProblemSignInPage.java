...
public class ProblemSignInPage extends HomePage {
    ...
    @FindBy(css = "[id='idLoginSupport']")
    private WebElement lnkProblemSignIn;

    public void clickProblemSignInLnk() {
        click(lnkProblemSignIn);
        log.info("Forgot password link clicked {}.");
    }    
    public boolean isclickProblemSignInLnkVisible() {
        log.info("Checking Forget password Link Visibility");
        return isElementVisible(lnkProblemSignIn);
    } 
