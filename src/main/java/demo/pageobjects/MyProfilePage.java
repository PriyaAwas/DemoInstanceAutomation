...
public class MyProfilePage extends HomePage {
	...
	public boolean isPrimaryPhoneErrorMssgDisplayed() {
		return isElementVisible(txtSecondarypValidation);
	...
	public boolean isDifferentPassErrorMssgDisplayed() {
		return isElementVisible(txtpwdValidation);
	}
	...
	public boolean isMandatoryToastMessageDisplayed() {
		return isElementVisible(txtToastMessage);
	}
	...
	@FindBy(css = "#btneditPwd")
	private WebElement btnEditPassword;

	public void clickPasswordEditButton() {
		click(btnEditPassword);
		log.info("Click on user Name Edit Button Successfully .");

	}

	@FindBy(css = "#txtPass1")
	private WebElement txtBoxExistPassField;

	public void clickExistingPassField() {
		click(txtBoxExistPassField);
		log.info("Click on existing pass field Successfully .");
	}

	public void enterPasswordInExistingPassField(String password) {
		sendKeys(txtBoxExistPassField, password);
		log.info("Entered password in the existing password field.");
	}

	@FindBy(css = "#txtNewPass1")
	private WebElement txtBoxNewPassField;

	public void clickNewPassField() {
		click(txtBoxNewPassField);
		log.info("Click on new pass field Successfully .");
	}

	public void enterPasswordInNewPassField(String password) {
		sendKeys(txtBoxNewPassField, password);
		log.info("Entered password in the new password field.");

	}

	@FindBy(css = "#txtConfirmPass1")
	private WebElement txtBoxVerifyNewPassField;

	public void clickVerifyNewPassField() {
		click(txtBoxVerifyNewPassField);
		log.info("Click on verify new pass field Successfully .");
	}

	public void enterPasswordInVerifyNewPassField(String password) {
		sendKeys(txtBoxVerifyNewPassField, password);
		log.info("Entered password in the verify new password field.");
	}

	@FindBy(css = "#btnProfileChangePassword")
	private WebElement btnSubmitPassword;

	public void clickSubmitPassButton() {
